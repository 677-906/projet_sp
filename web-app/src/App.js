...
import ChefZoneLayout from './components/ChefZoneLayout';
...
function App() {
  ...
  return (
    <Routes>
      ...
      {/* --- GROUPE DES ROUTES DU CHEF DE ZONE --- */}
      <Route path="/chef-zone" element={<PrivateRoute><ChefZoneLayout onLogout={handleLogout} /></PrivateRoute>}>
      ...
      {/* --- GROUPE DES ROUTES DU RESPONSABLE --- */}
      <Route path="/responsable" element={<PrivateRoute><ResponsableLayout onLogout={handleLogout} /></PrivateRoute>}>
        <Route index element={<Navigate to="dashboard" />} />
        <Route path="dashboard" element={<DashboardPage />} />
        <Route path="validations" element={<ValidationPage />} />
        <Route path="rejetes" element={<RejectedReportsPage />} />
      ...
      <Route path="/admin" element={<PrivateRoute><AdminLayout onLogout={handleLogout} /></PrivateRoute>}>
        ...
        <Route path="commerciaux" element={<CommercialManagementPage />} />
